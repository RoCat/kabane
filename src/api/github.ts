...
export async function loadKabaneConfig(
  ...
  return { columns, ticketTypes };
}

/**
 * Load all versions from the .kabane/versions.yml file
 */

export async function loadVersions(owner: string, repo: string, token: string, branch?: string): Promise<Version[]> {
  // Load versions
